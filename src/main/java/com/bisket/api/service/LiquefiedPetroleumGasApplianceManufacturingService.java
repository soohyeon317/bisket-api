...
import com.bisket.api.repository.LiquefiedPetroleumGasApplianceManufacturingRepository;
...
public class LiquefiedPetroleumGasApplianceManufacturingService implements BusinessBaseService {
    ...
    public Object getOne(Long id) {
        return liquefiedPetroleumGasApplianceManufacturingRepository.getOne(id);
    }
}
